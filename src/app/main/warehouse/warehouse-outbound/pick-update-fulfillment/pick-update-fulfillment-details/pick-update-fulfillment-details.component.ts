...
@Component({
    selector: 'pick-update-fulfillment-details-sidebar',
    templateUrl: './pick-update-fulfillment-details.component.html',
    styleUrls: ['./pick-update-fulfillment-details.component.scss'],
    animations: fuseAnimations
})
export class PickUpdateFulfillmentDetailsSidebarComponent implements OnInit, OnDestroy {
    selected: any;
    isEdit: boolean;
    dialogRef: any;
